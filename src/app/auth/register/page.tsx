...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Right Side - Visual */}
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-hilda-wine via-hilda-rose to-hilda-blush relative overflow-hidden">
        ...
        >
          <h2 className="font-display text-4xl font-light mb-4 leading-relaxed">
            عضو خانواده{' '}
            <span className="italic">Hilda</span> شوید
          </h2>
          <p className="text-white/50 font-light leading-8">
            از تخفیف‌های ویژه، محصولات جدید و پیشنهادات اختصاصی بهره‌مند شوید
          </p>
          <div className="mt-8 flex justify-center gap-4">
            <motion.div animate={{ y: [-5, 5, -5] }} transition={{ duration: 3, repeat: Infinity }} className="text-5xl opacity-40">
              💎
            </motion.div>
            <motion.div animate={{ y: [5, -5, 5] }} transition={{ duration: 4, repeat: Infinity }} className="text-5xl opacity-40">
              🎁
            </motion.div>
            <motion.div animate={{ y: [-3, 7, -3] }} transition={{ duration: 3.5, repeat: Infinity }} className="text-5xl opacity-40">
              ✨
            </motion.div>
          </div>
        </motion.div>
      ...
      {/* Left Side - Form */}
      <div className="flex-1 flex items-center justify-center px-4 py-12 bg-hilda-cream">
        <motion.div
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <User size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-hilda-charcoal/30" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <Phone size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-hilda-charcoal/30" />
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="w-4 h-4 rounded border-hilda-blush/30 text-hilda-wine focus:ring-hilda-rose/30 mt-0.5"
              />
              <label htmlFor="terms" className="text-xs text-hilda-charcoal/50 leading-5">
                <Link href="/terms" className="text-hilda-wine hover:underline">شرایط و قوانین</Link> و{' '}
                <Link href="/privacy" className="text-hilda-wine hover:underline">حریم خصوصی</Link> را مطالعه کرده و می‌پذیرم.
              </label>
            </div>
          ...
          <p className="text-center text-sm text-hilda-charcoal/50 mt-8">
            ...
            <Link href="/auth/login" className="text-hilda-wine font-medium hover:underline">
              وارد شوید
            </Link>
          </p>
        </motion.div>
